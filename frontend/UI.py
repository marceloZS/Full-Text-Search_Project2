...
class MainWindow(QMainWindow):
    def __init__(self):
       ...
       # Cargar la imagen del logo
        ...
        self.entrada.setStyleSheet("QLineEdit { color: #000000; font-size: 16px; font-weight: bold; text-shadow: 2px 2px 4px #000000; }")
        ...
        self.entrada_numero.setStyleSheet("QLineEdit { color: #000000; font-size: 16px; font-weight: bold; text-shadow: 2px 2px 4px #000000; }")
